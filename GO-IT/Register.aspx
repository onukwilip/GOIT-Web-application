<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="GO_IT.Register" %>
                          ...
                          <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
                              ...
                              <div class="u-custom-menu u-nav-container">
                                  <ul class="u-nav u-spacing-20 u-unstyled u-nav-1">
                                      ...
                                      <asp:Panel ID="login1" runat="server" CssClass="u-nav-item">
                                          <li class="u-nav-item">
          ...
          <section style="display:flex; justify-content:center; align-content:center; background:url(images/2743630793-01.jpeg); background-repeat:no-repeat; background-size:cover;"> 
              <div class="modal-login animate" id="modal2">
                ...
                <div name="modal-form" id="login_form">
                    <h1 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1" >LOGIN</h1>
                    ...
                    <label for="pword">
                        Password:<br />
                        <input type="password" id="pword" runat="server" />
                        
                    </label>
                    <br />
                    <label for="remember">
                        <!--<input type="checkbox" name="remember" id="remember" />--><asp:CheckBox ID="remember" runat="server" /> Remember me <br /> 
                    </label>
                    <asp:LinkButton ID="forgot" Text="Forgotten password?" runat="server" OnClick="forgot_Click" />
                    
                       <div align="center"> 
                           <asp:Button ID="signin" runat="server" CssClass="u-btn" Text="Login" OnClick="signin_Click"/>
                        
                        <div style="text-align:center;">OR</div>
                        
                        <div style="text-align:center; display:flex; justify-content:center;">
                            <button class="u-btn" style="width:100%; background-color:green;">Continue with Google</button>
                        </div>
                        <div style="text-align:center; display:flex; justify-content:center; margin-top:-20px;">
                            <button class="u-btn" style="width:100%;">Continue with Facebook</button>
                        </div>
                        
                        <span>No account? <a onclick="MySignup()">Sign Up</a></span>
                    </div>
                </div>

                <div name="modal-form" id="form_signup" style="display:none">
                    <h1 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1" >SIGN UP</h1>
                    ...
                    <br />
                    <label for="remind">
                        <input type="checkbox" name="remind" id="remind" /> Remember me
                    </label>
                    
                    
                   <div align="center">
                           <asp:Button ID="register" runat="server" CssClass="u-btn" Text="Sign Up" OnClick="SignUp" />
                    ...
                    <span>Already have an account? <a onclick="Signin()">Sign in</a></span>
                </div>
            </div>
               </div>
    <!--My Modal ends-->
