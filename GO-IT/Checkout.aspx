<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="GO_IT.Checkout" %>
...
<head>
      ...
      <!--u-sticky u-sticky-1702 <!--<a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-palette-1-base u-text-black u-text-hover-palette-2-base" href="#" style="padding: 10px;" runat="server"></a>  --> 
        <style>
            *{font-family:Montserrat;}
            ...
            input[type=text]{padding:10px; border:none; border-bottom:1px solid gray; font-family:Montserrat; box-sizing:border-box; width:100%;}
            input[type=date]{padding:10px; border:none; border-bottom:1px solid gray; font-family:Montserrat; box-sizing:border-box; width:100%;}
            input[type=text]:focus{padding:10px; outline:none; border-bottom:2px solid gray;}
            input[type=date]:focus{padding:10px; outline:none; border-bottom:2px solid gray;}
    ...
    <body data-home-page="Checkout.aspx" data-home-page-title="Checkout" class="u-body u-xl-mode">
            ...
            <tr>
                <td>
                    <section class="container-fluid">
                        <div class="row">
                            <div class="col-xl-5 first-halve animated slideInLeft">

                            </div>
                            <div class="col-xl-7 second-halve animated slideInRight" >
                                <asp:Panel ID="successful" runat="server" Visible="false" style="padding:20px; color:darkgreen; background-color:rgba(182, 255, 0, .7); border:1px double darkgreen; border-radius:15px;">
                                    <li>Item inserted successfully...</li>
                                </asp:Panel>
                                <h2>Checkout</h2>
                                <div class="row">
                                    <label class="col-xl-6">
                                        <input type="text" id="firstname" runat="server" class="" placeholder="Firstname..." />
                                        <asp:Label Visible="false" runat="server" ID="errorFname" CssClass="error" style="display:block; color:orangered" />
                                    </label>
                                    <label class="col-xl-6">
                                        <input type="text" id="lastname" runat="server" class="" placeholder="Lastname..." />
                                        <asp:Label Visible="false" runat="server" ID="errorLname" CssClass="error" style="display:block; color:orangered" />
                                    </label>
                                </div><br />
                                <div class="row">
                                    <label class="col-xl-12">
                                        <input type="text" id="cardname" runat="server" class="" placeholder="Card name..." />
                                        <asp:Label Visible="false" runat="server" ID="errorCardName" CssClass="error" style="display:block; color:orangered" />
                                    </label>
                                </div>
                                <div class="row">
                                    <label class="col-xl-12">
                                        <input type="text" id="cardnumber" runat="server" class="" placeholder="Card number..." />
                                        <asp:Label Visible="false" runat="server" ID="errorCardNo" CssClass="error" style="display:block; color:orangered" />
                                    </label>
                                </div><br />
                                <div class="row">
                                    <label class="col-xl-6">Total Amount:&nbsp;
                                        <input type="text" id="total" runat="server" placeholder="Total amount..." readonly />
                                    </label>
                                     <label class="col-xl-6">Expiry date:&nbsp;
                                        <input type="date" id="date" runat="server" placeholder="Expiry date..." />
                                         <asp:Label Visible="false" runat="server" ID="errorDate" CssClass="error" style="display:block; color:orangered" />
                                    </label>
                                </div><br />
                                <div class="row">
                                    <asp:Button ID="pay" runat="server" CssClass="u-btn btn-block btn-primary col-xl-12" Text="Pay with Paypal" OnClick="pay_Click" />
                                </div>
                            </div>
                        </div>
