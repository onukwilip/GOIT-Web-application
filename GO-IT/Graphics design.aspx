<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Graphics design.aspx.cs" Inherits="GO_IT.Graphics_design" %>
        ...
        <tr>
            <td>
                <section style="padding:20px;">
                    <h2 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1"><img src="images/3.png" style="width:30px; height:30px;" alt="">&nbsp;<dfn style="text-decoration:none; font-style:normal;" id="s_name1" runat="server"></dfn></h2>
                    <div id="big-div">
                       <!--<img src="images/abeae987a6f362b2cf8f4ccb5fc2c1efe2d3b6de1b7fef75bc8fc2e615714b65c2f3d2e648b2a0e1796d6fc39a2d3bc84f1cf7bf79570ab0164c33_1280.jpg" id="big-img" /> --> 
                        <div id="slider">
                            <ul id="slideWrap">
                                <li><img src="images/abeae987a6f362b2cf8f4ccb5fc2c1efe2d3b6de1b7fef75bc8fc2e615714b65c2f3d2e648b2a0e1796d6fc39a2d3bc84f1cf7bf79570ab0164c33_1280.jpg" id="image" runat="server" alt=""></li>
                                <li><img src="images/1813085405.jpeg" /></li>
                                <li><img src="images/166798-skeleton-graphic_design-japanese_graphic_design-cartoon-design-1280x720.jpg" /></li>
                                <li><img src="images/13-131908_photoshop-7-0-logo-adobe-photoshop-7-0-logo.png" /></li>
                                <li><img src="images/166797-rocket_digital_art-digital_art-illustration-art-graphics-1280x720.jpg" /></li>
                            </ul>
...
responsiveSlider();
                    ...
                    <div id="small-div">
                        ...
                        <blockquote>
                            One of the most popular aspect in the IT department, it goes way more than designing images, but is passion, as they once said 'Art is the expression of one's feelings'. 
                        </blockquote>
                    ...
                    <div class="row">
                        <div class="col-xl">
                            <span style="color:red;"><strike>NGN 3,000</strike></span> <span style="font-weight:bolder; font-size:30px; color:cornflowerblue;">NGN <em id="price" runat="server"></em></span>
                        </div>
                    </div>
                    <div style="width:100%;">
                ...
                <section style="padding:20px; color:white;" class="u-grey-80">
                    <h5 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1" ><b>Graphics design package</b> </h5>
                    <ul>
                        <li>Use of Corel draw suite interface to design and edit graphics, flyers, brochures, logos, etc...</li>
                        <li>Use of Adobe software to enhance images or edit contents. Eg: Photoshop, illustrator, fireworks, etc...</li>
                    </ul>

                    <h5 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1"> Services </h5>
                    <ul>
                        <li>Logo creation, designing and editing.</li>
                        <li>3D mockup logos in vector format, editable, in .jpg, .png extensions. </li>
                        <li>Flyers and brochures designing...</li>
                        <li>Image editing...</li>
                        <li>DI (Direct image)</li>
                    </ul>

                    <h5 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1"> Requirements </h5>
                    <ul>
                        <li>The graphics document (If you want us to edit existing one).</li>
                ...
                <section class="row" style="padding:10px 30px;">
                    ...
                    <div class="col-xl-12">
                         <label>
                            <input type="checkbox" id="extrapage" value="Extra page" onchange="extrapages()" runat="server"/>  Extra document/project &nbsp;&nbsp;&nbsp;+NGN <span id="page_price" runat="server">1000</span>&nbsp;&nbsp;&nbsp;<input type="number" style="display:none; width:100%" min="1" value="1" id="pageqty" onchange="qty()" runat="server" />
                        </label><br />
                       
                        <h3 class="col-xl-12">
                            Total amount: NGN<input type="text" id="tryTotal" runat="server" value="2000" readonly /><input type="text" id="initial" runat="server" value="2000" readonly style="display:none" />
                        </h3>
