    ...
    public partial class Web_development : System.Web.UI.Page
    {
        ...
        protected void Submit(object sender, EventArgs e)
        {
            try
            {
                ...
                string id = "003", client = _ID != null ? _ID.Value.Split('=')[1] : "undefined", orderid = new GeneralClass()._random().ToString(), Mydesc = description.Value, Myfeatures = features.Value, _Myfunc = functionality.Value, _MyData = database.Value, ext = Path.GetExtension(zipfile.FileName);
