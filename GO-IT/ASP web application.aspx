<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ASP web application.aspx.cs" Inherits="GO_IT.ASP_web_application" %>
...
<body data-home-page="ASP web application.aspx" data-home-page-title="ASP.NET web application" class="u-body u-xl-mode">
            ...
            <td>
                <section style="padding:20px;">
                    ...
                    <div id="big-div">
                        ...
                        <div id="slider">
                            <ul id="slideWrap">
                                <li><img src="images/asp-net.jpeg" id="image" runat="server"/></li>
...
responsiveSlider();
                    ...
                    <div style="width:100%;">
                        <a role="button" class="u-btn" style="display:inline-block;" id="order" href="#details">
                            Order Now !
                        </a>
                ...
                <section class="row" style="padding:10px 30px;">
                    ...
                    <div class="col-xl-12">
                        <ul style="list-style: inside">
                            <li>Designing of responsive User-firendly interface</li>
                            ...
                            <li>1 - 10 number of pages</li>
                           <!-- <li>28 days delivery</li> -->
                            <li>Free 1 year hosting(Only sites under 2GB disk storage)</li>
                        </ul>
                    </div>
                </section>
                ...
                <section class="row" style="padding:10px 30px;">
                    ...
                    <div class="col-xl-12">
                        ...
                        <label>
                            <input type="checkbox" id="hosting" value="Extra hosting" onchange="extrahost()" runat="server"/> Hosting site (more than 2GB) &nbsp;&nbsp;&nbsp;+NGN <span id="host_price" runat="server">15000</span>
                        </label><br /><br />

                        <h3 class="col-xl-12">
                            Total amount: NGN<input type="text" id="tryTotal" runat="server" value="55000" readonly /><input type="text" id="initial" runat="server" value="55000" readonly style="display:none" />
                        </h3>
