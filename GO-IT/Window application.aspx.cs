...
namespace GO_IT
{
    public partial class Window_application : System.Web.UI.Page
    {
        string id = "006";
        int alltotal = 0;
        ...
        protected void Submit(object sender, EventArgs e)
        {
            ...
            string id = "006", client = _ID != null ? _ID.Value.Split('=')[1] : "undefined", orderid = new GeneralClass()._random().ToString(), Mydesc = description.Value, Myfeatures = features.Value, _Myfunc = functionality.Value, _MyData = database.Value;
            ...
            string allFeatures = string.Concat(features.Value, "; ", "Number of forms:", pages.Value, "; ");
                    ...
                    if (read.Read() == true)
                    {
                        ...
                        else
                        {
                          ...
                          /*  if (extrapage.Checked==true)
                            {
                                string extra_insert = "INSERT INTO CartExtra(Name, ID, OrderID, Price) VALUES('" + extrapage.Value + "', '" + new GeneralClass()._random().ToString() + "', '" + orderid + "', " + Convert.ToInt32(page_price.InnerHtml) + ")";
                            ...
                            Response.Redirect("Window application.aspx");
                        }
