...
namespace GO_IT
{
    public partial class Graphics_design : System.Web.UI.Page
    {
        ...
        protected void Submit(object sender, EventArgs e)
        {
            ...
            string id = "005", client = _ID != null ? _ID.Value.Split('=')[1] : "undefined", orderid = new GeneralClass()._random().ToString(), Mydesc = description.Value, Myfeatures = features.Value;
