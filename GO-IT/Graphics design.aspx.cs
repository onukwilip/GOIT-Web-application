...
namespace GO_IT
{
    public partial class Graphics_design : System.Web.UI.Page
    {
        string id = "005";
        int alltotal = 0;
        ...
        protected void Submit(object sender, EventArgs e)
        {
            try
            {
                ...
                string id = "005", client = _ID != null ? _ID.Value.Split('=')[1] : "undefined", orderid = new GeneralClass()._random().ToString(), Mydesc = description.Value, Myfeatures = features.Value, ext = Path.GetExtension(zipfile.FileName);
                ...
                string allFeatures = string.Concat(features.Value, "; ");
                    ...
                    if (_read.Read() == true)
                    {
                        ...
                        if (read.Read() == true)
                        {
                            ...
                            else
                            {
                                ...
                                Response.Redirect("Graphics design.aspx");
                            }
