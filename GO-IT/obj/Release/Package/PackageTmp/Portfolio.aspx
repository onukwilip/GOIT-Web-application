<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Portfolio.aspx.cs" Inherits="GO_IT.Portfolio" %>
...
<html style="font-size: 16px;">
  <head>
    ...
    <meta property="og:type" content="website">
      <style>
        ...
        input[type=text]:focus, input[type=date]:focus, input[type=number]:focus, input[type=tel]:focus, textarea 
  ...
  <body data-home-page="Portfolio.aspx" data-home-page-title="Portfolio" class="u-body u-xl-mode">
