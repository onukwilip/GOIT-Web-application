<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Word processing.aspx.cs" Inherits="GO_IT.Word_processing" %>
...
<body data-home-page="Word processing.aspx" data-home-page-title="Word processing" class="u-body u-xl-mode">
        ...
        <tr>
            <td>
                <section style="padding:20px;">
                    <h2 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1"><img src="images/2.png" style="width:30px; height:30px;" alt="">&nbsp;<dfn style="text-decoration:none; font-style:normal;" id="s_name1" runat="server"></dfn></h2>
                    <div id="big-div">
                        ...
                        <div id="slider">
                            <ul id="slideWrap">
                                <li><img src="images/cc24004b-3648-459a-a427-92b968bd416b.jpg" id="image" runat="server" /></li>
                                <li><img src="images/xc.jpg" /></li>
                                <li><img src="images/depositphotos_110282344-stock-photo-person-typing-on-laptop-with.jpg" /></li>
                                <li><img src="images/613-6131007_microsoft-excel-2016-logo-png-transparent-png.png" /></li>
                                <li><img src="images/82-825755_download-microsoft-office-365-png-office-365-pro.png" /></li>
                            </ul>
...
responsiveSlider();
                    ...
                    <div id="small-div">
                        ...
                        <blockquote>
                            Desktop publishing comprises of Microsoft Office Word, Excel, Powerpoint, Pagemaker, e.t.c...the following softwares are used to create document, i.e:
                        </blockquote>

                        <blockquote>
                           <b> Microsoft Word:</b>
                            <br />
                            This is used to create office text document.
                            <br />
                           <b> Microsoft Excel:</b>
                            <br />
                            This is used to create spreadsheet packages for analytics, e.t.c...
                            <br />
                           <b> Microsoft Powerpoint: </b>
                            This is used to create slideshows, animations for document presentation...
                        </blockquote>
                    </div>
                    <br />
                    ...
                    <div class="row">
                        <div class="col-xl">
                            <span style="color:red;"><strike>NGN 2,000</strike></span> <span style="font-weight:bolder; font-size:30px; color:cornflowerblue;">NGN <em id="price" runat="server"></em></span>
                        </div>
                    </div>
                ...
                <section style="padding:20px; color:white;" class="u-grey-80">
                    <blockquote>
                        Here at GO IT we're gonna create documents for your office use, according to your choice using the above softwares.
                    </blockquote>
                    <h5 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1"><b>Desktop Publishing Package</b> </h5>
                    <ul>
                        <li>Use of microsoft office word / pagemaker to create office related documents.</li>
                        <li>Use of microsoft excel to create spreadsheet packages.</li>
                        <li>Use of powerpoint to create slideshows and presentations.</li>
                    </ul>
                 ...
                 <section class="row" style="padding:10px 30px;">
                    ...
                    <div class="col-xl-12">
                        <ul style="list-style: inside">
                            <li>Spreadsheet packages</li>
                            <li>Slideshows</li>
                            <li>.txt/.pdf files</li>
                            <li>Soft copy ONLY</li>
                            <li>1 - 10 number of pages/slides</li>
                        </ul>
                    </div>
                </section>
                 ...
                 <section class="row u-grey-80" style="padding:10px 30px; height:auto" id="details" >
                    ...
                    <div class="col-xl-12 ">
                        ...
                        <label>Number of pages:<br />
                            <input type="number" required min="1" value="" id="pages" max="10" runat="server" /> <asp:Label Visible="false" runat="server" ID="errorPages" CssClass="error" />
                        </label><br />
                ...
                <section class="row" style="padding:10px 30px;">
                    ...
                    <div class="col-xl-12">
                        <label>
                            <input type="checkbox" id="extrapage" value="Extra page" onchange="extrapages()" runat="server"/>  Extra page &nbsp;&nbsp;&nbsp;+NGN <span id="page_price" runat="server">200</span>&nbsp;&nbsp;&nbsp;<input type="number" style="display:none; width:100%" min="1" value="1" id="pageqty" onchange="qty()" runat="server" />
                        </label><br />
                        
                        <h3 class="col-xl-12">
                            Total amount: NGN<input type="text" id="tryTotal" runat="server" value="1000" readonly /><input type="text" id="initial" runat="server" value="1000" readonly style="display:none" />
                        </h3>
