<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web design.aspx.cs" Inherits="GO_IT.Web_design" %>
            ...
            <td>
                <section style="padding:20px;">
                    ...
                    <div id="big-div">
                        ...
                        <div id="slider">
                            <ul id="slideWrap">
                                <li><img src="images/web-design.jpg" id="image" runat="server" /></li>
                                <li><img src="images/web-design2.jpg" /></li>
                                <li><img src="images/web-design3.jpg" /></li>
                                <li><img src="images/html.jpg" /></li>
                                <li><img src="images/javascript.jpg" /></li>
                            </ul>
...
responsiveSlider();
                    ...
                    <div id="small-div">
                        ...
                        <blockquote>
                            Our team will create and develop responsive, mobile friendly websites, with a nice user-interface and few plugins.
                        </blockquote>
                    </div>
                    <br />
                    <div class="row">
                        <div class="col-xl">
                            <span style="color:red;"><strike>NGN 35,000</strike></span> <span style="font-weight:bolder; font-size:30px; color:cornflowerblue;">NGN <em id="price" runat="server"></em></span>
                        </div>
                    </div>
                    <div style="width:100%;">
                ...
                <section style="padding:20px; color:white;" class="u-grey-80">
                    ...
                    <h5 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1"><b>Web Design Package</b> </h5>
                    <ul>
                        <li>Use of HTML, CSS and Javascript to cteate responsive websites.</li>
                ...
                <section class="row" style="padding:10px 30px;">
                    ...
                    <div class="col-xl-12">
                        <ul style="list-style: inside">
                            <li>Creation and designing of landing pages and portfolio websites</li>
                            <li>Beautiful UI/UX design</li>
                            <li>Unlimited revisions</li>
                            <li>1 - 4 number of pages</li>
                            <li>Free 1 year hosting(Only sites under 30GB disk storage)</li>
                        </ul>
                    </div>
                </section>
                ...
                <section class="row u-grey-80" style="padding:10px 30px; height:auto" id="details" >
                    ...
                    <div class="col-xl-12 ">
                        ...
                        <label>Number of pages:<br />
                            <input type="number" required min="1" value="" id="pages" runat="server" max="10" /> <asp:Label Visible="false" runat="server" ID="errorPages" CssClass="error" />
                        </label><br />
                ...
                <section class="row" style="padding:10px 30px;">
                    ...
                    <div class="col-xl-12">
                         <label>
                            <input type="checkbox" id="extrapage" value="Extra page" onchange="extrapages()" runat="server"/>  Extra page &nbsp;&nbsp;&nbsp;+NGN <span id="page_price" runat="server">2500</span>&nbsp;&nbsp;&nbsp;<input type="number" style="display:none; width:100%" min="1" value="1" id="pageqty" onchange="qty()" runat="server" />
                        </label><br />
                        <label>
                            <input type="checkbox" id="extrafunction" value="Extra functionality" onchange="extrafunc()" runat="server"/> Extra functionality &nbsp;&nbsp;&nbsp;+NGN <span id="func_price" runat="server">5000</span>
                        </label><br />
                        ...
                        <label>
                            <input type="checkbox" id="extradata" value="Uploadable contents" onchange="extradbase()" runat="server"/> Uploadable Contents (Database included) &nbsp;&nbsp;&nbsp;+NGN <span id="dbase_price" runat="server">7000</span>
                        </label><br />
                      ...
                      <!--  <label>
                            <input type="checkbox" id="hosting" value="Extra hosting" onchange="extrahost()" runat="server"/> Hosting site (more than 2GB) &nbsp;&nbsp;&nbsp;+NGN <span id="host_price" runat="server">10000</span>
                        </label><br /><br /> -->

                        <h3 class="col-xl-12">
                            Total amount: NGN<input type="text" id="tryTotal" runat="server" value="25000" readonly /><input type="text" id="initial" runat="server" value="25000" readonly style="display:none" />
                        </h3>
