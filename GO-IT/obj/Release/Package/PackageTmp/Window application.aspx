<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Window application.aspx.cs" Inherits="GO_IT.Window_application" %>
...
<head>
    ...
    <style>
        ...
        {padding:10px; border:none; border-bottom:1px solid gray; font-family:Montserrat; box-sizing:border-box; width:100%; background:inherit;}
        input[type=text]:focus, input[type=date]:focus, input[type=number]:focus, input[type=tel]:focus 
        {padding:10px; outline:none; border-bottom:2px solid gray;}
        ...
        @media only screen and (max-width: 620px) {
            ...
            #details input[type=text], input[type=date], input[type=number], textarea
            {
                width:100%;
            }
        }
...
<body data-home-page="Window application.aspx" data-home-page-title="Window application" class="u-body u-xl-mode">
        ...
        <tr>
            <td>
                <section style="padding:20px;">
                    <h2 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1"><img src="images/4.png" style="width:30px; height:30px;" alt="">&nbsp;<dfn style="text-decoration:none; font-style:normal;" id="s_name1" runat="server"></dfn></h2>
                    <div id="big-div">
                        ...
                        <div id="slider">
                            <ul id="slideWrap">
                                <li><img src="images/windows.jpg" id="image" runat="server"/></li>
                                <li><img src="images/windows2.jpg" /></li>
                                <li><img src="images/windows3.jpg" /></li>
                                <li><img src="images/windows4.jpg" /></li>
...
responsiveSlider();
                    ...
                    <div id="small-div">
                        ...
                        <blockquote>
                            Windows applications are softwares programmed to perform a specific task, it runs on only the Windows Operating system. Examples of applications that run on Windows OS are the Microsoft Outlook, Internet Explorer, Remote Desktop Condition, Snipping Tool, and numerous others. We'll create windows applications using C# programming and .NET framework.
                        </blockquote>
                    </div>
                    <br />
                    <div class="row">
                        <div class="col-xl">
                            <span style="color:red;"><strike>NGN 125,000</strike></span> <span style="font-weight:bolder; font-size:30px; color:cornflowerblue;">NGN <em id="price" runat="server"></em></span>
                        </div>
                    </div>
                    <div style="width:100%;">
                ...
                <section style="padding:20px; color:white;" class="u-grey-80">
                    ...
                    <h5 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1"><b>Windows Application Package</b> </h5>
                    <ul>
                        <li>Use of C# programming, and .NET framework to create Windows software.</li>
                        <li>Use of Microsoft SQL to create database for your software</li>
                ...
                <section class="row" style="padding:10px 30px;">
                    ...
                    <div class="col-xl-12">
                        <ul style="list-style: inside">
                            <li>Use of .NET framework to develop window based softwares</li>
                            <li>Use of C# programming language to develop server side processing</li>
                            <li>Beautiful UI/UX interface</li>
                            <li>Database integration</li>
                            <li>Fixing of bugs in already existing softwares based on the .NET framework and C#</li>
                            <li>Email/SMS API integragtion</li>
                            <li>Multiuser interface</li>
                            <li>Ability to save and give report on existing data(Inventory)</li>
                ...
                <section class="row u-grey-80" style="padding:10px 30px; height:auto" id="details" >
                    ...
                    <div class="col-xl-12">
                        <label>Project name:<br />
                            <input type="text" placeholder="E.g GOIT..." id="name" runat="server" /> <asp:Label Visible="false" runat="server" ID="errorName" CssClass="error" />
                        </label><br />
                       <!-- <label>Domain name:<br />
                        ...
                        <label>Number of forms:<br />
                            <input type="number" required min="1" value="" id="pages" runat="server" /> <asp:Label Visible="false" runat="server" ID="errorPages" CssClass="error" />
                        </label><br />
                ...
                <section class="row" style="padding:10px 30px;">
                    <h2>EXTRAS</h2>
                    <div class="col-xl-12">
                       <!-- <input type="text" class="no-display" id="myFourteen" runat="server" /> -->
                        <input type="text" class="no-display" id="myExtrapage" runat="server" />
                        <input type="text" class="no-display" id="myFunctionality" runat="server" />
                        <input type="text" class="no-display" id="myDatabase" runat="server" />
                        <input type="text" class="no-display" id="myHost" runat="server" />
                       
                        <label>
                            <input type="checkbox" id="extrafunction" value="Extra functionality" onchange="extrafunc()" runat="server"/> Extra functionality &nbsp;&nbsp;&nbsp;+NGN <span id="func_price" runat="server">10000</span>
                        </label><br />
                        ...
                        <label>
                            <input type="checkbox" id="extradata" value="Extra database" onchange="extradbase()" runat="server"/> Extra database &nbsp;&nbsp;&nbsp;+NGN <span id="dbase_price" runat="server">5000</span>
                        </label><br />
                        ...
                        <h3 class="col-xl-12">
                            Total amount: NGN<input type="text" id="tryTotal" runat="server" value="100000" readonly /><input type="text" id="initial" runat="server" value="100000" readonly style="display:none" />
                        </h3>
