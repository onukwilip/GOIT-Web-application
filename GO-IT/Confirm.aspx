<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Confirm.aspx.cs" Inherits="GO_IT.Confirm" %>
          ...
          <section style="display:flex; justify-content:center; align-content:center; background:url(images/32e1d1d559de737257f125559608f6f5.jpeg); background-repeat:no-repeat; background-size:cover;"> 
              <div class="modal-login animate" id="modal2">
                ...
                <div name="modal-form" id="login_form">
                    <h1 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1" >CONFIRM YOUR EMAIL ADDRESS</h1>

                    <p class="u-custom-font u-font-montserrat u-text u-text-default u-text-1" runat="server" id="context">A confirmation code has been sent to <cite>someone@example.com</cite> please input the confirmation code here...</p>

                    <label for="Username">
                        
                        <input type="text" id="confirmcode" runat="server" placeholder="Enter code here" />
                    </label>
                   <asp:LinkButton ID="_resend" runat="server" OnClick="resend_Click">Resend Link</asp:LinkButton>
                       <div align="center"> 
                           <asp:Button ID="confirmation" runat="server" CssClass="u-btn" Text="Confirm" OnClick="confirmation_Click"/>
                     </div>
                </div>
